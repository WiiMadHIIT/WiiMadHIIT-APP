/// 语音训练会话配置实体
class TrainingVoiceSessionConfig {
  ...
  /// 本地配置，不需要从API获取
  factory TrainingVoiceSessionConfig.defaultConfig() {
    return TrainingVoiceSessionConfig(
      totalRounds: 1,
      roundDuration: 60,
      preCountdown: 10,
  ...
  /// 创建自定义配置
  factory TrainingVoiceSessionConfig.custom({
  ...
  /// 复制并更新字段
  TrainingVoiceSessionConfig copyWith({
    int? totalRounds,
    int? roundDuration,
    int? preCountdown,
  ...
  /// 从Map创建
  factory TrainingVoiceSessionConfig.fromMap(Map<String, dynamic> map) {
    return TrainingVoiceSessionConfig(
  ...
  @override
  String toString() {
    return 'TrainingVoiceSessionConfig(totalRounds: $totalRounds, roundDuration: $roundDuration, preCountdown: $preCountdown, audioDetectionEnabled: $audioDetectionEnabled, backgroundType: $backgroundType)';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is TrainingVoiceSessionConfig &&
