...
class CheckinTrainingResult {
  ...
  /// 创建训练结果
  factory CheckinTrainingResult.create({
  ...
  /// 从API响应创建训练结果
  factory CheckinTrainingResult.fromResponse({
    required String id,
    required String trainingId,
    String? productId,
    required double countsPerMin,
  ...
  /// 复制并更新字段
  CheckinTrainingResult copyWith({
    String? id,
    String? trainingId,
    String? productId,
    double? countsPerMin,
  ...
  /// 从Map创建
  factory CheckinTrainingResult.fromMap(Map<String, dynamic> map) {
    return CheckinTrainingResult(
      id: map['id'] as String,
  ...
  @override
  String toString() {
    return 'CheckinTrainingResult(id: $id, trainingId: $trainingId, productId: $productId, countsPerMin: $countsPerMin, totalSeconds: $totalSeconds, counts: $counts, timestamp: $timestamp)';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is CheckinTrainingResult &&
        other.id == id &&
