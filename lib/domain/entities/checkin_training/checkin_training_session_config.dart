/// 训练会话配置实体
class CheckinTrainingSessionConfig {
  ...
  /// 本地配置，不需要从API获取
  factory CheckinTrainingSessionConfig.defaultConfig() {
    return CheckinTrainingSessionConfig(
      totalRounds: 1,
      roundDuration: 60,
      preCountdown: 10,
  ...
  /// 创建自定义配置
  factory CheckinTrainingSessionConfig.custom({
  ...
  /// 复制并更新字段
  CheckinTrainingSessionConfig copyWith({
    int? totalRounds,
    int? roundDuration,
    int? preCountdown,
  ...
  /// 从Map创建
  factory CheckinTrainingSessionConfig.fromMap(Map<String, dynamic> map) {
    return CheckinTrainingSessionConfig(
  ...
  @override
  String toString() {
    return 'CheckinTrainingSessionConfig(totalRounds: $totalRounds, roundDuration: $roundDuration, preCountdown: $preCountdown, audioDetectionEnabled: $audioDetectionEnabled, backgroundType: $backgroundType)';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is CheckinTrainingSessionConfig &&
