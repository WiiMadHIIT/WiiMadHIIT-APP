...
class ChekinTrainingVoicePage extends StatefulWidget {
  ...
  const ChekinTrainingVoicePage({Key? key, required this.trainingId}) : super(key: key);

  @override
  State<ChekinTrainingVoicePage> createState() => _ChekinTrainingVoicePageState();
}

class _ChekinTrainingVoicePageState extends State<ChekinTrainingVoicePage> with TickerProviderStateMixin {
