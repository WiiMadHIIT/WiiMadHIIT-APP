...
class _CheckinTrainingVoicePageState extends State<CheckinTrainingVoicePage> with TickerProviderStateMixin, WidgetsBindingObserver {
  ...
  Future<Map<String, dynamic>> _getTrainingDataAndVideoConfigApi() async {
    ...
    final mockVideoConfig = {
      "portraitUrl": "https://example.com/videos/voice_training_portrait.mp4", // 远程竖屏视频URL
      "landscapeUrl": "https://example.com/videos/voice_training_landscape.mp4", // 远程横屏视频URL
    };
